...
const HERO_CONTENT = {
  ...
  highlight: "Nós resolvemos isso.",
  description:
    "Organizamos operações de verdade. Sem promessas vazias, sem PowerPoint bonito que vira gaveta. Entramos na sua empresa, entendemos o sistema e construímos juntos.",
